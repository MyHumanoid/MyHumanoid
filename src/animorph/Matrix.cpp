...
glm::vec3 operator*(const glm::vec3 & v, const Matrix & m) // REDO
{
	...
	return glm::vec3(v.x * m.data[0] + v.y * m.data[4] + v.z * m.data[8] + m.data[12],
...
Matrix operator*(const Matrix & a, const Matrix & b)
{
	...
	r.data[0] = a.data[0] * b.data[0] + a.data[4] * b.data[1] + a.data[8] * b.data[2] +
	            a.data[12] * b.data[3];
	r.data[4] = a.data[0] * b.data[4] + a.data[4] * b.data[5] + a.data[8] * b.data[6] +
	            a.data[12] * b.data[7];
	r.data[8] = a.data[0] * b.data[8] + a.data[4] * b.data[9] + a.data[8] * b.data[10] +
	            a.data[12] * b.data[11];
	r.data[12] = a.data[0] * b.data[12] + a.data[4] * b.data[13] + a.data[8] * b.data[14] +
	             a.data[12] * b.data[15];
	r.data[1] = a.data[1] * b.data[0] + a.data[5] * b.data[1] + a.data[9] * b.data[2] +
	            a.data[13] * b.data[3];
	r.data[5] = a.data[1] * b.data[4] + a.data[5] * b.data[5] + a.data[9] * b.data[6] +
	            a.data[13] * b.data[7];
	r.data[9] = a.data[1] * b.data[8] + a.data[5] * b.data[9] + a.data[9] * b.data[10] +
	            a.data[13] * b.data[11];
	r.data[13] = a.data[1] * b.data[12] + a.data[5] * b.data[13] + a.data[9] * b.data[14] +
	             a.data[13] * b.data[15];
	r.data[2] = a.data[2] * b.data[0] + a.data[6] * b.data[1] + a.data[10] * b.data[2] +
	            a.data[14] * b.data[3];
	r.data[6] = a.data[2] * b.data[4] + a.data[6] * b.data[5] + a.data[10] * b.data[6] +
	            a.data[14] * b.data[7];
	r.data[10] = a.data[2] * b.data[8] + a.data[6] * b.data[9] + a.data[10] * b.data[10] +
	             a.data[14] * b.data[11];
	r.data[14] = a.data[2] * b.data[12] + a.data[6] * b.data[13] + a.data[10] * b.data[14] +
	             a.data[14] * b.data[15];
	...
	r.data[3] = a.data[3] * b.data[0] + a.data[7] * b.data[1] + a.data[11] * b.data[2] +
	            a.data[15] * b.data[3];
	r.data[7] = a.data[3] * b.data[4] + a.data[7] * b.data[5] + a.data[11] * b.data[6] +
	            a.data[15] * b.data[7];
	r.data[11] = a.data[3] * b.data[8] + a.data[7] * b.data[9] + a.data[11] * b.data[10] +
	             a.data[15] * b.data[11];
	r.data[15] = a.data[3] * b.data[12] + a.data[7] * b.data[13] + a.data[11] * b.data[14] +
	             a.data[15] * b.data[15];
