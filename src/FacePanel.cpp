...
void FacePanel::createWidgets()
{
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_02.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_03.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_04.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_05.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_07.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_08.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_09.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_11.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_12.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_16.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_18.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_19.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_20.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_22.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_23.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
	...
	// -------------------------------------------------------------------------
	face = new Image(kComponentID_Dummy, searchPixmapFile("ui/face_24.png"),
	                 Rect(0, 0, 32, 32));
	face->setAlpha(alpha);
	imageVector.push_back(face);
	addWidget(face);
