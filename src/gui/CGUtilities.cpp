...
void cgutils::drawSquareFill(const mhgui::Rect & inRect, const Color & c)
{
	...
	glTexCoord2f(1, 0);
	glVertex3f(inRect.pos.x + inRect.getWidth(), inRect.pos.y, zlayer);
	glTexCoord2f(1, 1);
	glVertex3f(inRect.pos.x + inRect.getWidth(), inRect.pos.y + inRect.getHeight(), zlayer);
	glTexCoord2f(0, 1);
...
void cgutils::drawSquare(const Rect & inRect, const Color & c)
{
	...
	glVertex3f(inRect.pos.x - 1 + inRect.getWidth(), inRect.pos.y, zlayer);
	glVertex3f(inRect.pos.x - 1 + inRect.getWidth(), inRect.pos.y + inRect.getHeight(),
	           zlayer);
	glVertex3f(inRect.pos.x, inRect.pos.y + inRect.getHeight(), zlayer);
	glEnd();
}
