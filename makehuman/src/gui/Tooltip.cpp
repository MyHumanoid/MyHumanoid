 ...
 */
/* ========================================================================== */
Tooltip::Tooltip(const std::string & inTooltipString, const Point & inPos, const Color & inColor,
 ...
 */
/* ========================================================================== */
Tooltip::Tooltip(const std::string & inTooltipString, const Point & inPos, const Panel * inAnchor)
        : label(inTooltipString)
        , pos(inPos)
...
void Tooltip::draw() const
{
	...
	if(anchorPanel == NULL) {
		cgutils::drawSquareFill(
		        Rect(-3, -12, cgutils::getFontLength(GLUT_BITMAP_HELVETICA_12, label) + 3,
		             16),
		        Color(0, 0, 0));
