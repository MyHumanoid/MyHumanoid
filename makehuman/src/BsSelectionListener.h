...
#ifndef BSSELECTIONLISTENER_H
#define BSSELECTIONLISTENER_H 1
...
class BsSelectionListener : public AbstractListener
{
public:
	BsSelectionListener();
	virtual ~BsSelectionListener();
