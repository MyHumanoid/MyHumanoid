...
static const string kConsoleMessage_Save_Autozoom              = "Save Autozoom file (*.camera)";
static const string kConsoleMessage_Save_Autozoom_Success      = "Autozoom saved";

static const string kConsoleMessage_Load_Animations            = "Load animation (select a valid dir)";
static const string kConsoleMessage_Load_Animations_Success    = "Animation loaded";
...
//static const string kConsoleMessage_Save_Animations            = "Save animation (select a valid dir)";
//static const string kConsoleMessage_Save_Animations_Success    = "Animation saved";

static const string kConsoleMessage_Export_Object              = "Export OBJ file (insert a valid export path)";
static const string kConsoleMessage_Export_Object_Success      = "OBJ file exported. Press ESC to exit.";

static const string kConsoleMessage_Export_Collada              = "Export Collada DAE file (insert a valid export path)";
static const string kConsoleMessage_Export_Collada_Success      = "Collada DAE file exported. Press ESC to exit.";


static const string kConsoleMessage_Dir_Load_Error             = "Error: couldn't read directory. Press ESC to exit or ENTER to retry!";
//static const string kConsoleMessage_Dir_Save_Error             = "Error: couldn't save files. Press ESC to exit or ENTER to retry!";
static const string kConsoleMessage_Load_Error                 = "Error: couldn't load file. Press ESC to exit or ENTER to retry!";
static const string kConsoleMessage_Save_Error                 = "Error: couldn't save file. Press ESC to exit or ENTER to retry!";
static const string kConsoleMessage_Unknown_Command            = "Unknown command";
static const string kConsoleMessage_InvalidPath                = "Error: the path doesn't exist.";
static const string kConsoleMessage_WrongPath                  = "Error: the path is wrong. Impossible locate rendering";
...
static const string kConsoleMessage_ConfirmExit                = "Do you really want to quit? (press ENTER to quit)";// or press ESC to return)";

static const string kConsoleMessage_WrongMode_Animations       = "This command can be executed only in Utilities panel";
static const string kConsoleMessage_WrongMode_Poses            = "This command can be executed only in Poses panel";
static const string kConsoleMessage_WrongMode_BodyDetails      = "This command can be executed only in Body details, Character settings or Clothes panel";

static const string kConsoleMessage_NotLoaded_Animations       = "Animations not loaded!";
static const string kConsoleMessage_OK                         = "O.K.! path stored, press Esc to Exit";
static const string kConsoleMessage_Parameter_OK               = "O.K.! parameter stored, press Esc to Exit";
static const string kConsoleMessage_Parameter_NG               = "Error! parameter not stored, press Esc to Exit";
