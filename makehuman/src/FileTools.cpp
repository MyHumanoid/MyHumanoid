 ...
 * @param inCreateIntermediateDirs set this to true whether the function should
 * create the given path in inDstFilename if it does not exists. You may omit
 * this parameter - in this case it defaults to false.
 *
 * @return true on success, or false on failure.
 *
 * Failure could be:
 *  o inSrcFilename and inDstFilename are identical names;
 *  o Either the source- or the destination File could not be successful
 * read/written;
 */
/* ========================================================================== */
                         ...
                         bool inCreateIntermediateDirs)
{
	...
	if (rdFile >= 0) {
		int wrFile =
		    ::open(inDstFilename.c_str(), O_WRONLY | O_CREAT | O_TRUNC, wrPerm);
		if (wrFile >= 0) {
 ...
 * @param inFilename the File to examine.
 *
 * @return the last modification time of the given file in ms since Jan-1st-1970
 * or 0L if the file does not exists.
 *
 ...
 * @param inFilename the File to examine.
 *
 * @return the last status change time of the given file in ms since
 * Jan-1st-1970 or 0L if the file does not exists.
 *
 * @see getLastAccessTime(const char*)
 * @see getLastModificationTime(const char*)
 */
