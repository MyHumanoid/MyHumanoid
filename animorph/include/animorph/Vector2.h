...
template <typename T> class Vector2decimal : public Vector2<T>
{
public:
	Vector2decimal()
	    : Vector2<T>()
	...
	Vector2decimal(T _x, T _y)
	    : Vector2<T>(_x, _y)
	{
	}
	Vector2decimal(const Vector2<T> &v)
	    : Vector2<T>(v)
	{
	}
...
template <typename T> class Vector2real : public Vector2<T>
{
public:
	Vector2real()
	    : Vector2<T>()
	...
	Vector2real(T _x, T _y)
	    : Vector2<T>(_x, _y)
	{
	}
	Vector2real(const Vector2<T> &v)
	    : Vector2<T>(v)
	{
	}
...
public:
	...
	Vector2f(float _x, float _y)
	    : Vector2real<float>(_x, _y)
	{
	}
	Vector2f(const Vector2<float> &v)
	    : Vector2real<float>(v)
	{
	}
...
public:
	...
	Vector2d(double _x, double _y)
	    : Vector2real<double>(_x, _y)
	{
	}
	Vector2d(const Vector2<double> &v)
	    : Vector2real<double>(v)
	{
	}

	virtual ~Vector2d() {}

	virtual double getMagnitude() const { return sqrt(x * x + y * y); }
};
...
template <typename T> void Vector2real<T>::normalize()
{
...
template <typename T> Vector2<T> &Vector2<T>::operator=(const Vector2<T> &v1)
{
	x = v1.x;
	y = v1.y;
...
template <typename T> inline Vector2<T> &Vector2<T>::operator*=(const T scalar)
{
	x *= scalar;
	y *= scalar;
