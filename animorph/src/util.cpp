 ...
 */
int Animorph::replaceString (const string& match, const string& replace, string& str, unsigned int maxReplace)
{
  int start = 0;
  unsigned int i = 0;
...
Vector3f Animorph::calcCenteroid(const vector<int>& vertexNumbers, const VertexVector& vertexvector)
{
  Vector3f center;
  center.zero();
...
Vector3f Animorph::calcAverageNormalLength(const vector<int> vertexNumbers, const VertexVector& vertexvector)
{
