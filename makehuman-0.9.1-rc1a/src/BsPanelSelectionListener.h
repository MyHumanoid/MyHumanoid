 ...
 *  USA
 *
 *  File   : BsPanelSelectionListener.h
...
#ifndef BSPANELSELECTIONLISTENER_H
#define BSPANELSELECTIONLISTENER_H 1
...
class BsPanelSelectionListener : public AbstractListener
{
public:
  BsPanelSelectionListener();
  virtual ~BsPanelSelectionListener();
...
#endif //BSPANELSELECTIONLISTENER_H
