...
void ToolbarPanel::createWidgets ()
{
  ...
  image = new Image(kComponentID_ImageToolbarPanel_LoadBodysettings,
                    searchPixmapFile ("ui/toolbar_load.png"),
                    Rect(0,0,32,32));
  ...
  image = new Image(kComponentID_ImageToolbarPanel_SaveBodysettings,
                    searchPixmapFile ("ui/toolbar_save.png"),
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  ...
  image = new Image(kComponentID_ImageToolbarPanel_ExportWavefrontObj,
                    searchPixmapFile ("ui/toolbar_exp.png"),
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  ...
  image = new Image(kComponentID_ImageToolbarPanel_ExportColladaObj,
                    ...
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  image->setTooltip(Tooltip("Export Collada file", kTooltipPos, color_red, tooltipPanel));
  image->setAlpha (alpha);
  imageVector.push_back (image);
  addWidget (image);
...
*/
  ...
  image = new Image(kComponentID_ImageToolbarPanel_Poses,
                    searchPixmapFile ("ui/toolbar_poses.png"),
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  ...
  image = new Image(kComponentID_ImageToolbarPanel_BodySettings,
                    ...
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  image->setTooltip(Tooltip("Characters Library", kTooltipPos, color_red, tooltipPanel));
  image->setAlpha (alpha);
  imageVector.push_back (image);
  addWidget (image);
  ...
  image = new Image(kComponentID_ImageToolbarPanel_PoseBodySettings,
                    ...
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  image->setTooltip(Tooltip("Poses Library", kTooltipPos, color_red, tooltipPanel));
  image->setAlpha (alpha);
  imageVector.push_back (image);
  addWidget (image);
  ...
  // -------------------------------------------------------------------------
#ifdef _ANIMATIONS
  image = new Image(kComponentID_ImageToolbarPanel_Animation,
                         searchPixmapFile ("ui/toolbar_util.png"),
                         Rect(0,0,32,32));
  image->setListener(&imgListener1);
...
*/
  ...
  image = new Image(kComponentID_ImageToolbarPanel_Rendering,
                    searchPixmapFile ("ui/toolbar_rend.png"),
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  ...
  image= new Image(kComponentID_ImageToolbarPanel_RenderingPreview,
                        ...
                        Rect(0,0,32,32));
  image->setListener(&imgListener1);
  image->setTooltip(Tooltip("Rendering preview", kTooltipPos, color_red, tooltipPanel));
  image->setAlpha (1.0);
  imageVector.push_back (image);
  addWidget (image);
  ...
  // -------------------------------------------------------------------------
  image = new Image(kComponentID_ImageToolbarPanel_Reset,
                         searchPixmapFile ("ui/toolbar_reset.png"),
                         Rect(0,0,32,32));
  image->setListener(&imgListener1);
  image->setTooltip(Tooltip("Reset Mesh", kTooltipPos, color_red, tooltipPanel));
  image->setAlpha (alpha);
  imageVector.push_back (image);
  addWidget (image);
  ...
  image = new Image(kComponentID_ImageToolbarPanel_LoadBackground,
                    ...
                    Rect(0,0,32,32));
  image->setListener(&imgListener1);
  image->setTooltip(Tooltip("Load Background", kTooltipPos, color_red, tooltipPanel));
  image->setAlpha (alpha);
  imageVector.push_back (image);
  addWidget (image);
