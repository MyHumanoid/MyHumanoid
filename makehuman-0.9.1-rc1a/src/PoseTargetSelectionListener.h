 ...
 *  USA
 *
 *  File   : PoseTargetSelectionListener.h
...
#ifndef POSETARGETSELECTIONLISTENER_H
#define POSETARGETSELECTIONLISTENER_H 1
...
class PoseTargetSelectionListener : public AbstractListener
{
public:
  PoseTargetSelectionListener();
  virtual ~PoseTargetSelectionListener();
...
#endif //POSETARGETSELECTIONLISTENER_H
