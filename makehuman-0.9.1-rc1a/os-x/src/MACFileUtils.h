...
#ifndef _MACFileUtils_H_
#define _MACFileUtils_H_

#if !(defined(__APPLE__) && defined(__MACH__))
    #warning "This Header and its functions are supported on MAC OS ONLY!"
#endif
...
const string getSystemDocumentsFolderPath();


#endif // _MACFileUtils_H_
